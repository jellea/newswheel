...
goog.require('hickory.utils');
hickory.core.HiccupRepresentable = (function (){var obj10195 = {};return obj10195;
})();
...
hickory.core.HickoryRepresentable = (function (){var obj10197 = {};return obj10197;
})();
...
(hickory.core.as_hiccup["object"] = (function (this$){var pred__10199 = cljs.core._EQ_;var expr__10200 = (this$["nodeType"]);if(cljs.core.truth_(pred__10199.call(null,hickory.core.Attribute,expr__10200)))
...
(hickory.core.as_hickory["object"] = (function (this$){var pred__10202 = cljs.core._EQ_;var expr__10203 = (this$["nodeType"]);if(cljs.core.truth_(pred__10202.call(null,hickory.core.Attribute,expr__10203)))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else
{if(cljs.core.truth_(pred__10202.call(null,hickory.core.Comment,expr__10203)))
...
{if(cljs.core.truth_(pred__10202.call(null,hickory.core.Document,expr__10203)))
...
{if(cljs.core.truth_(pred__10202.call(null,hickory.core.DocumentType,expr__10203)))
...
{if(cljs.core.truth_(pred__10202.call(null,hickory.core.Element,expr__10203)))
...
{if(cljs.core.truth_(pred__10202.call(null,hickory.core.Text,expr__10203)))
{return (this$["wholeText"]);
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__10203)].join('')));
}
}
}
}
...
var temp__4092__auto___10205 = cljs.core.first.call(null,(doc["head"]["childNodes"]));if(cljs.core.truth_(temp__4092__auto___10205))
{var title_el_10206 = temp__4092__auto___10205;if(cljs.core.empty_QMARK_.call(null,(title_el_10206["text"])))
{hickory.core.remove_el.call(null,title_el_10206);
} else
{}
} else
{}
